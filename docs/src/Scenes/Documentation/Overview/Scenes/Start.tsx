...
const Start = (props) => (
    <Container>
        ...
        <div className="npm" style={{marginBottom: '1.5rem'}}><code><span className="is-unselectable">$ </span>
        npm install bloomer</code></div>
        <Subtitle>
        ...
        <p>
            Bloomer has <a href="https://webpack.js.org/guides/tree-shaking/">Tree-Shaking</a> in mind, if your
             bundle can handle this, then you can get the benefit of Bloomer and Tree-Shaking.
        </p>
        <br/>
