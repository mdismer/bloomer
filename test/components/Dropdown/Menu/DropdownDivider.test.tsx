...
describe('Dropdown', () => {
    it('should rendern hr with .dropdown-divider', () => {
        const component = shallow(<DropdownDivider>My DropdownDivider</DropdownDivider>);
    ...
    it('should rendern an img with .dropdown-divider', () => {
        const component = shallow(<DropdownDivider tag="img">My DropdownDivider</DropdownDivider>);
