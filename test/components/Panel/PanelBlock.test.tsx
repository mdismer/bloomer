...
describe('PanelBlock', () => {
    it('should render a custom component with PanelBlock props', () => {
        ...
        const component = shallow(<PanelBlock href='#' isActive render={customComponent} />);
    ...
    it('should render a label with .panel-block', () => {
     ...
     it('should render an anchor with .panel-block', () => {
        ...
        expect(component.contains(<a href='#' className='panel-block'>My PanelBlock</a>)).toBe(true);
    });

    it('should render a div with .panel-block', () => {
        const component = shallow(<PanelBlock>My PanelBlock</PanelBlock>);
        expect(component.contains(<div className='panel-block'>My PanelBlock</div>)).toBe(true);
    });

    it('should render a div with .panel-block and modifiers', () => {
        const component = shallow(<PanelBlock isActive isWrapped className='custom'><span>Any Content</span></PanelBlock>);
    ...
    it('should render a div with .panel-block, modifiers and custom classNames', () => {
        const component = shallow(<PanelBlock className='custom'><span>Any Content</span></PanelBlock>);
        expect(component.hasClass('panel-block')).toBe(true);
        expect(component.hasClass('custom')).toBe(true);
    });
