...
describe('NavbarBurger', () => {
    it('should render a div with .navbar-burger', () => {
        ...
        expect(component.contains(<div className='navbar-burger'><span /><span /><span /></div>)).toBe(true);
    });

    it('should render a p with .navbar-burger', () => {
        const component = shallow(<NavbarBurger tag='p' />);
        expect(component.contains(<p className='navbar-burger'><span /><span /><span /></p>)).toBe(true);
    });
