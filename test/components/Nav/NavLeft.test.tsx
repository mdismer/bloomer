...
describe('NavLeft', () => {
    ...
    it('should render a p with .nav-left', () => {
        const component = shallow(<NavLeft tag='p'>My NavLeft</NavLeft>);
        expect(component.contains(<p className='nav-left'>My NavLeft</p>)).toBe(true);
    });
