...
describe('Columns', () => {
    ...
    it('should render a p with .columns', () => {
        const component = shallow(<Columns tag='p'>Any Content</Columns>);
        expect(component.contains(<p className='columns'>Any Content</p>)).toBe(true);
    });
