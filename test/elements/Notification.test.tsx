...
describe('Notification', () => {
    ...
    it('should render a p with .notification', () => {
        const component = shallow(<Notification tag='p'>My Notification</Notification>);
        expect(component.contains(<p className='notification'>My Notification</p>)).toBe(true);
    });

    it('should render a div with .notification and modifiers', () => {
        const component = shallow(<Notification isColor='black'>My Notification</Notification>);
    ...
    it('should render a div with .notification, modifiers and custom classNames', () => {
        const component = shallow(<Notification isColor='primary' className='custom'><span>Any Content</span></Notification>);
        expect(component.hasClass('notification')).toBe(true);
